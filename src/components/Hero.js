...
const Hero = () => (
  <div className="hero">
    ...
    <div className="info_text">
      ...
      <p className="pitch">
        I am seeking a developer position where I can expand my skills and efficient while improving my technical skills and build my career as a professional developer.
      </p>
      <Link to="/projects">
