      ...
      <div className="container">
        ...
        <div className="container_detail">
          ...
          <div className="container_text">
              ...
              <p>
                I am a loving husband and a new father of a precious 6 months old boy. When I am not coding to further improve my skills and learn the newest tech, I am for sure having fun with my son, wife or trying a YouTube recipe for my family on a Sunday.      
              </p>
          </div>
        </div>
      </div>
